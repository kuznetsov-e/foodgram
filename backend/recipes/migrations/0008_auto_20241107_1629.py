...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('recipes', '0007_recipe_short_code'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'default_related_name': 'recipe_ingredients', 'verbose_name': 'Ингредиент', 'verbose_name_plural': 'Ингредиенты'},
        ),
        migrations.AlterModelOptions(
            name='tag',
        ...
        migrations.AlterField(
            model_name='recipe',
            name='image',
            field=models.ImageField(upload_to='recipe_images/', verbose_name='Фото'),
        ),
        migrations.AlterField(
            model_name='recipe',
            name='ingredients',
        ...
        migrations.AlterField(
            model_name='recipe',
            name='short_code',
            field=models.CharField(blank=True, max_length=5, unique=True, verbose_name='Код для короткой ссылки'),
        ),
        migrations.AlterField(
            model_name='recipe',
            name='tags',
